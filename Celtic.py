...
dic = {
 ...
 "Mountain Ash":["Pleasant","Charming","Even_Tempered","Friendliness","Independent","Self_Centered","Over_Thinkers","Lack_Simplicity","Very_Attentive","Beautiful","Long_for_perfection","Honest","Loyal","Reliable","Perfectionists","Extremely_Generous","Demanding"],
...
#d1 = (parse("11/10/1996",dayfirst=True).date())
#print(d1," ", type(d1))
